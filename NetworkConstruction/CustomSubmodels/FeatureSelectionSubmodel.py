...
class FeatureSelectionSubmodel(CustomSubmodel):
    ...
    def imp_pass(self, list_of_inputs, func = tf.nn.relu):
        ...
        global_m = func(tf.multiply(current_output_exp, weights_exp))
    ...
    def get_activ_importances(self, x, output_imp_prior):
        ...
        last_layer_imp = self.imp_pass([output_imp_prior, outs[-1], self.out_layer.kernel], tf.abs)
